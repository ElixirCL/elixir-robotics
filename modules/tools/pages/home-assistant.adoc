...
Luego, se debe agregar el servicio MQTT https://www.home-assistant.io/integrations/mqtt/#broker-configuration[a través de la interfaz web de Home Assistant].
...
[NOTE]
====
Reemplaza `"192.168.1.14"` en el código del ESP32 con la dirección IP real del host del broker.
====
