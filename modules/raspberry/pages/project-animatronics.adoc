...
.Lego Búho (#31125)
image::lego-buho.webp[https://www.tiendalego.cl/products/criaturas-fantasticas-del-bosque-31125]
...
image::animatronico-esquema.png[]

.Guía de Conexiones
image::animatronico-conexion.png[]

.Video de Ejemplo de Funcionamiento
video::animatronico.mp4[]
