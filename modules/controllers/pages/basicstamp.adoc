...
En 1997, Parallax produjo la Board of Education, un portaplacas de pruebas (breadboard) y placa de proyectos para el BASIC Stamp 2.
Educadores de USA solicitaron rápidamente que se montara en un robot, y así se creó el Boe-Bot. 
Combinado con el libro de Andy Lindsay https://learn.parallax.com/courses/robotics-with-the-boe-bot/["Robotics with the Boe-Bot"] y https://learn.parallax.com/courses/whats-a-microcontroller/["What’s a Microcontroller"], esta combinación de hardware y 
tutoriales se convirtió en un producto educativo popular.

Hoy en día, _PBASIC_ sigue siendo uno de los lenguajes favoritos de muchos educadores y aulas, 
y gran parte de la investigación educativa inicial sobre la eficacia de los sistemas de 
computación física para enseñar programación utilizó el BASIC Stamp.

El Boe-Bot utiliza el lenguaje _PBASIC_. Los robots Boe-Bot se encuentran en escuelas 
secundarias y preparatorias, escuelas técnicas y universidades, clubes de robótica y en los 
hogares de aficionados.

Son excelentes compañeros para aprender o enseñar tecnología, mecatrónica y programas STEM. 
Este kit de robot puede utilizarse como una asignatura optativa en muchas escuelas.

.Basic Stamp Boe-Bot
image::basicstamp/boebot.webp[]

El siguiente código de PBasic muestra cómo reproducir una canción utilizando el formato de música RTTL 
utilizado por teléfonos Nokia de principios de la década del 2000.
...
Un Basic Stamp en Chile puede ser adquirido en https://rambal.com/15-basic-stamp[Rambal Robots].
