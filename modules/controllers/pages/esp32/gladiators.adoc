...
image::esp32/gladiator/gladiador.jpg[]

.Combate de Gladiadores Robot
video::esp32/gladiator/5-5-2025-uvm.mp4[]
...
image::esp32/gladiator/gladiator_diagram.png[]
...
[NOTE]
====
Las pilas son conectadas a los motores y al ESP32 de forma separada, 
gracias a la placa de expansión se conecta al Jack de carga directamente a las pilas 
ya que este aguanta hasta 16v sin problemas.
====
...
image::esp32/gladiator/gladiador-lego.webp[]
