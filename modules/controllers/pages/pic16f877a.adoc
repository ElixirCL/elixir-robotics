...
image::pic16f877a/44pin.jpg[alt="_PIC16F877a_ 44 Pinout", width=400]
_Fuente: Microchip Technology_

.Diagrama del microcontrolador 40 pins _PIC16F877a_
image::pic16f877a/40pin.jpg[alt="PIC16F18855", width=400]
_Fuente: Microchip Technology_
...
.Logo de MPLAB
image::pic16f877a/mplab.avif[alt="MPLAB", width=200]
_Fuente: Microchip Technology_
...
image::pic16f877a/MCC_PINS.png[alt="MPLAB", width=400]
_Fuente: MPLAB Xpress_

.Cambio de nombre terminales
image::pic16f877a/rename.png[alt="Cambio_nombre_terminales", width=400]
_Fuente: MPLAB Xpress_

.Figure 6: Ajuste de reloj interno
image::pic16f877a/control.png[alt="clock_control", width=400]
_Fuente: MPLAB Xpress_
...
.Ajuste CLC
image::pic16f877a/clc.png[alt="clc", width=400]
_Fuente: MPLAB Xpress_
