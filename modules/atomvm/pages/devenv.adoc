...
Para instalar `idf.py` se puede utilizar los siguientes comandos
...
Ahora se puede iniciar en `.bashrc` o `.zshrc`
para que este disponible la herramienta `idf.py`

[source, bash]
----
. $HOME/.espressif/esp-idf/export.sh &> /dev/null
----

[source, bash]
----
$ idf.py --version
ESP-IDF v6.1-dev-5824-gfa8039b5ca-dirty
----
