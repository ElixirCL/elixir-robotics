...
*AtomVM* comenzó su desarrollo en el año 2018 por *Davide Bettio* con el objetivo de llevar Elixir y Erlang a un hardware más pequeño. 
...
- Atomvm. (n.d.). GitHub - atomvm/AtomVM: Tiny Erlang VM. GitHub. https://github.com/atomvm/AtomVM
- atomvm.net. (n.d.). AtomVM. AtomVM. https://www.atomvm.net/
- Sifoni, L. (2023, November 16). Lucas Sifoni - Hello AtomVM — Elixir & Erlang on ESP32. Lucas Sifoni. https://lucassifoni.info/blog/hello-atomvm/
- Getting Started Guide — AtomVM 0.7.0-dev+git.65f16e87 documentation. (n.d.). https://www.atomvm.net/doc/master/getting-started-guide.html
