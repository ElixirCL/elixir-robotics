...
.Componentes de Arcade Posibles
|====
...
| 22        | Resistor (a LED RGB Rojo) | Salida PWM para controlar el color Rojo del LED RGB
| 21        | Resistor (a LED RGB Verde) | Salida PWM para controlar el color Verde del LED RGB
| 23        | Resistor (a LED RGB Azul) | Salida PWM para controlar el color Azul del LED RGB
|===
