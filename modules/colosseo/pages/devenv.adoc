...
Se recomienda usar __Devenv__ para gestionar dependencias del sistema. El siguiente archivo `devenv.nix` define todas las dependencias necesarias para compilar un proyecto Elixir a `avm`, y luego flashear el resultado a un ESP32:
